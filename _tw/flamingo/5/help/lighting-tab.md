...
攝影棚照明預設組是針對中小型物件 (珠寶與產品設計) 桌上攝影最佳化的照明配置。此預設組裡的太陽是關閉的，並以一張 HDR 圖片做為表面具反射性質的物件的反射影像。
...
當[太陽](sun-and-sky-tabs.html#sun)開啟時，場景設定必需區分[室內](#interior)或[戶外](#exterior)，因為天空的亮度、地面反射的光線與物件反射的光線對照明的影響在室內與戶外有很大的差別，正確地設定[室內/戶外](#indirect)可以讓彩現較有效率，效果也會較為真實。

通常室內與戶外場景很容易區別，當攝影機位於建築物之外即為戶外場景；攝影機位於建築物之內即為室內場景。但有些場景就不是有那麼明顯的區別，例如：建築物的中庭、建築物的爆炸圖或剖面圖。以建築物的中庭為例，當中庭的面積大，四周建物較低時，這樣的場景會有比較多的天空照明，可以把它當做戶外場景看待。當中庭的面積小，四周建物較高時，場景會比較類似室內場景，這樣的情形可以在中庭上方放置"日光入口"物件，將天空照明導入場景。
...
### 環境光
{: #ambient}
環境光可提高場景的整體亮度，這裡的設定可控制環境光的強弱。

降低環境光的強度可提高彩現影像的對比度，太強的環境光會讓彩現影像看起來平淡無趣，太弱又會造成對比度過高的問題。
