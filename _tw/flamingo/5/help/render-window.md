...
### 多層次彩現
{: #multi-pass}
Flamingo nXt 使用全新的彩現引擎，使用多層次細化得到進階彩現效果，同時簡化操作界面的複雜度。彩現一開始的幾個處理數的彩現影像可能會有許多瑕疵，例如：許多邊緣銳利相互重疊的陰影。這些陰影會隨著處理數增加逐漸混合變細緻。有許多其它彩現效果也會隨著處理數增加而改善，彩現視窗的 [Flamingo 標籤](#flamingo-tab) 可顯示彩現的進度資訊。
