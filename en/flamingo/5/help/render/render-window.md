...
![brightnessdefault.png](brightnessdefault.png)
...
![saturationdefault.png](saturationdefault.png)
...
![toggleeffect.png](toggleeffect.png)Toggle the on/off state of the selected effect.
![moveup.png](moveup.png)Move the selected effect up in the list.
![movedown.png](movedown.png)Move the selected effect down in the list.
![effectproperties.png](effectproperties.png)Selected effect properties.
![savelistorderasdefault.png](savelistorderasdefault.png)Save the current effects list order and properties as default.
![savecurrenteffectslist.png](savecurrenteffectslist.png)Save the current effects list as named list.
![importnamedeffectslist.png](importnamedeffectslist.png)Import named effects list.

## Depth of Field
The Depth of Field effect blurs the image depending on the distance from the camera.
![../image/postprocessing-dof.png](../image/postprocessing-dof.png)
...
![../image/postprocessing-nofog.png](../image/postprocessing-nofog.png)
...
![../image/postprocessing-fogasgradient.png](../image/postprocessing-fogasgradient.png)
*Fog as gradient background.*
...
![../image/postprocessing-noglare.png](../image/postprocessing-noglare.png)
...
![../image/postprocessing-glowassparkle.png](../image/postprocessing-glowassparkle.png)
*Glow as sparkle.*
![../image/postprocessing-glowon.png](../image/postprocessing-glowon.png)
...
![posteffectwires-001.png](posteffectwires-001.png)
