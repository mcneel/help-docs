...
![materialchannel.png](materialchannel.png)
...
*![combinedpathtrace200.png](combinedpathtrace200.png) *Rendered with 20 passes (left), ten 20-pass images combined to create a 200-pass image (right).* *
...
![imageandalpha.png](imageandalpha.png)
...
*![golden gate.png](golden gate.png)Original image (left) and with haze (right).*
...
![fx-depth-001.png](fx-depth-001.png)
...
*![blur-001.png](blur-001.png)Blur foreground (left) and background (right).*
...
*![glare-001.png](glare-001.png)Original image (left) and with glare (right).*
...
*![fx-vignette-001.png](fx-vignette-001.png)Original image (left) and with vignette (right).*
