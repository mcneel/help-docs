...
![cylindricaldecal-002.png](cylindricaldecal-002.png)
### Planar
...
![decal-planar-001.png](decal-planar-001.png)
### UV Map
...
![uvmapdecal-00.png](uvmapdecal-00.png)
### Browse
...
![../image/projectionbackward1.png](../image/projectionbackward1.png)Front (left), back (right).

### Forward
Projects the decal away from the front of the decal image.
![../image/projectionforward1.png](../image/projectionforward1.png)Front (left), back (right).

### Forward &amp; Backward
Projects the decal away from both the front and the back of the decal image.
![../image/projectionforwardandback.png](../image/projectionforwardandback.png)Front (left), back (right).
