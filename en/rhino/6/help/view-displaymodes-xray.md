...
TheX-Raydisplay mode shades with [isoparametric curves](isocurve.html) not obscured by objects in front.
...
### Grid settings
Grid usage{: #kanchor2933}{: #kanchor2934}{: #kanchor2935}
...
### World axes settings
World axis icon color usage{: #kanchor2936}
...
Use transparent grid{: #kanchor2938}
...
### Selection
Shaded modes only
Shade-highlight selected surfaces and polysurfaces{: #kanchor2940}{: #kanchor2941}
...
Line thickness{: #kanchor2946}{: #kanchor2947}
...
Rhinoceros 6 © 2010-2015 Robert McNeel &amp; Associates.11-Nov-2015
 [Open topic with navigation](view-displaymodes-xray.html) 
