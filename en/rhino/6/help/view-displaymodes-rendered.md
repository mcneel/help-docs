...
TheRendereddisplay mode sets the viewport to a shaded mode with a simulation of the rendered view.
...
Note
The rendered display mode supports a linear workflow. A linear workflow is one in which texture maps are gamma corrected to make for better looking renders.See: [LinearWorkflow.](http://renderman.pixar.com/view/LinearWorkflow) 
...
![images/transparentbackground-001.png](images/transparentbackground-001.png)
 [![images/transparent.gif](images/transparent.gif)Shading settings](javascript:void(0);) Shade objects
...
Multi-channel mappingsSpherical and cylindrical display for low-polygon-count meshes, especially at the poles.Decals3-D procedural texturesIn the following illustration, the object has a wood material that has world coordinate mapping and a decal. WithAdvanced texture previewturned off, the preview display does not match the rendered output since it does not display the wood texture or the decal.
![images/advancedtexturepreview-002.png](images/advancedtexturepreview-002.png)
...
### Grid settings
Grid usage{: #kanchor2868}{: #kanchor2869}{: #kanchor2870}
...
### World axes settings
World axis icon color usage{: #kanchor2871}
...
Use transparent grid{: #kanchor2873}
...
### Selection
Shaded modes only
Shade-highlight selected surfaces and polysurfaces{: #kanchor2875}{: #kanchor2876}
...
Line thickness{: #kanchor2881}{: #kanchor2882}
...
Rhinoceros 6 © 2010-2015 Robert McNeel &amp; Associates.11-Nov-2015
 [Open topic with navigation](view-displaymodes-rendered.html) 
